...
export function CoversFilter({ listLoading }) {
  // covers UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(coversUIProps.queryParams, values);
    if (!isEqual(newQueryParams, coversUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      coversUIProps.setQueryParams(newQueryParams);
    }
  };
