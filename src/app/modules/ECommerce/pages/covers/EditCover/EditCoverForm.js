...
const CoverEditSchema = Yup.object().shape({
  ...
  coverCode: Yup.string().required("coverCode is required"),
              ...
              <Form className="form form-label-right">
                <div className="form-group row">
                  ...
                  <div className="col-lg-4">
                    ...
                    <option  value={cover?.productId._id || null}>
                            {cover?.productId.desc || null}
                            </option> 
                ...
                <div className="form-group row">
                  <div className="col-lg-4">
                    <Select name="parentCover" label="Parent Cover">
                  <option  value={cover.parentCover?._id || null}>
                            {cover.parentCover?.nameEn || null}
                            </option> 
